...
public class CommonAttributesApplicator {
    ...
    public void applyCommonAttributes(JRDesignElement target,
        ...
        applyStretchType(target, source);
    ...
    private void applyStretchType(JRDesignElement target, JrxmlElement source) {
        if (source.getStretchType() == null) return;
        StretchTypeEnum stretchType = StretchTypeEnum.getByName(source.getStretchType());
        if (stretchType != null) target.setStretchType(stretchType);
    }
