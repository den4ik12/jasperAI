...
public class TextFieldConverter implements JrxmlElementConverter {
    ...
    private static final String TRUNCATE_AT_CHAR_PROPERTY = "net.sf.jasperreports.text.truncate.at.char";
    ...
    public JRDesignElement convert(JrxmlElement element, Map<StyleKey, JRDesignStyle> stylesMap) {
        ...
        textField.getPropertiesMap().setProperty(TRUNCATE_AT_CHAR_PROPERTY, "true");
