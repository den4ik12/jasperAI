...
class CoordinateScalingStepTest {
    ...
    @Test
    void sourceFormatKeepsUploadedPageSize() {
        ...
        step.execute(contextWith(data, PageFormat.SOURCE));

        assertEquals(794, data.getPageWidth());
        assertEquals(1123, data.getPageHeight());
        assertEquals(100, el.getX());
        assertEquals(200, el.getY());
        assertEquals(400, el.getWidth());
        assertEquals(80, el.getHeight());
        assertEquals(16, el.getFontSize());
    }
