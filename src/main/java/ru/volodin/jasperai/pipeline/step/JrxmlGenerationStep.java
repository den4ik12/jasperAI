...
public class JrxmlGenerationStep implements PipelineStep {
    ...
    public void execute(PipelineContext context) {
        ...
        if (context.getSourcePageWidth() != null) {
            data.setPageWidth(context.getSourcePageWidth());
        }
        if (context.getSourcePageHeight() != null) {
    ...
    private boolean isBackgroundFrame(JrxmlFrame frame) {
        return frame.getElements() == null || frame.getElements().stream()
                .noneMatch(e -> e.getType() == ElementType.TEXT_FIELD || e.getType() == ElementType.STATIC_TEXT);
    }
    ...
    private boolean hasGeometry(JrxmlElement element) {
        return element.getX() != null
                && element.getY() != null
                && element.getWidth() != null
                && element.getHeight() != null;
    }

    private boolean hasGeometry(JrxmlFrame frame) {
        return frame.getX() != null
                && frame.getY() != null
                && frame.getWidth() != null
