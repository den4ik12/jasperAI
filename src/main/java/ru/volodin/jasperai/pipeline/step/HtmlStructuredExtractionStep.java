...
public class HtmlStructuredExtractionStep implements PipelineStep {
    ...
    private static final String SYSTEM_PROMPT = """
            ...
            - Для каждого элемента добавь поле elementId равное значению атрибута id соответствующего HTML-элемента. Если у элемента нет атрибута id — поднимись вверх по DOM-дереву и возьми id ближайшего предка у которого он есть.
            - elementId — это ТОЛЬКО значение атрибута id="...". Атрибут class НИКОГДА не является источником для elementId, даже если значение класса содержит цифры или напоминает идентификатор. Пример: <div id="2_81"><div class="stroke-2_81">...</div></div> — elementId должен быть "2_81", но НЕ "stroke-2_81" и НЕ "Pixso-rectangle-2_81".
